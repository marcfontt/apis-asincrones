...
Durant el desenvolupament s'han emprat eines d'intel\textperiodcentered lig\`encia artificial generativa, concretament ChatGPT, com a suport al proc\'es de programaci\'o i revisi\'o de codi. En cap cas s'han utilitzat per generar contingut que l'estudiant no entengu\'es o no pogu\'es validar. L'\'us d'aquestes eines es declara de forma expl\'icita i es detalla a l'apartat de Metodologia, d'acord amb els criteris d'integritat acad\`emica establerts per la guia del PFG.
...
Durant el desenvolupament del projecte s'han fet servir eines d'intel\textperiodcentered lig\`encia artificial generativa com a suport complementari al treball de l'estudiant. L'eina utilitzada ha estat ChatGPT, d'OpenAI.
