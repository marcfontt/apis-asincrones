...
els conceptes de productor, broker, consumidor i metrica amb una lectura pas a
pas. Cataleg documenta
...
NATS, streaming de video 4K amb Kafka, cas financer amb RabbitMQ, streaming 4K
pel cami Confluent compatible amb Kafka i un control base de Kafka. El format de
video 8K continua disponible, pero es tracta com una prova de payload gran:
abans d'usar-lo com a dada comparativa cal validar els limits de Kafka
...
precaucio evita interpretar com a rendiment dolent el que en realitat seria una
limitacio de configuracio en missatges de 2 MB.
